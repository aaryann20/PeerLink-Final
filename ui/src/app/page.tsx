  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <header className="text-center mb-12 fade-in">
        <h1 className="text-5xl font-extralight tracking-tight mb-4">PeerLink</h1>
        <p className="text-2xl text-gray-700 font-light">Effortless. Secure. Peer-to-Peer File Sharing.</p>
      </header>
      
      <div className="bg-white/80 rounded-2xl shadow-xl p-8 card-animate backdrop-blur-md">
